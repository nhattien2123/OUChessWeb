...
export const fetchPatchUpdateUser = async (profile: userState["currentUser"]): Promise<Types.ResFetchPatchUpdateUser> => {
...
export const fetchPatchChangePassword = async (username: string, newPassword: string): Promise<Types.ResFetchPatchChangePassword> => {
...
export const fetchPatchChangeAvatar = async (username: string, form: FormData): Promise<Types.ResFetchPatchChangeAvatar> => {
