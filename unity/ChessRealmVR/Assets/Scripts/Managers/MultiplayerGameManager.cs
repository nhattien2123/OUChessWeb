    ...
    public class MultiplayerGameManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (CurrentPlayer.HasMoved)
            {
                ...
                CurrentPlayer = CurrentPlayer == OtherPlayer ? HumanPlayer : OtherPlayer;
                CurrentPlayer.IsMyTurn = true;
                if (CurrentPlayer == HumanPlayer) CurrentPlayer.EnablePieces();

                movementManager.GenerateAllMoves(LastTurn, CurrentPlayer, movementManager.ChessPieces, tileManager.Tiles, HumanPlayer.Pieces, OtherPlayer.Pieces);
            ...
            //socket.Emit('send-move', CreateMoveData());
        }
        ...
        private Move CreateMoveData(Turn turn)
        {
